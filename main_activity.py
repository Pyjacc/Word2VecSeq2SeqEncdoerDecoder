...
def main():
    ...
    parser.add_argument("--embedding_dim", default=256, help="Words embeddings dimension", type=int)
    ...
    parser.add_argument("--attention_units", default=256,
